...
from .models import  collaborations, Co_Investigator, project_details, Time_Frame,study_design, pat_sel_id, study_step, work_up, prog_report, comp_report, clinical_studies
...
class CustomStudentCreationForm(UserCreationForm):
    ...
    def save(self):
        ...
        student = Student.objects.create(student_id=user,guide = guide_obj)
        print(student)
...
class princi_form(forms.ModelForm):
    class Meta:
        ...
        fields = ['P_name','P_designation','P_Dept','P_contact','P_email' ]
        labels ={
            'P_name':'Name',
            'P_designation':'Designation',
            'P_Dept':'Department','P_contact':'Contact','P_email':'Email',
        }
...
class coinv_form(forms.ModelForm):
    class Meta:
        ...
        fields = ['Co_name','Co_designation','Co_contact_no','Co_email']
        labels = {'Co_name': 'Name', 'Co_designation': 'Designation',
            'Co_contact_no': 'Contact', 'Co_email': 'Email'}


class research_fellow_form(forms.ModelForm):
    class Meta:
        model = Std_details
        fields = ['st_name', 'st_designation', 'st_contact_no', 'st_email']
        labels = {'st_name': 'Name', 'st_designation': 'Designation',
                  'st_contact_no': 'Contact', 'st_email': 'Email'}
